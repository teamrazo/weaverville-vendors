...
export default function ApplicationPage() {
  ...
  return (
    ...
    <div className="bg-white rounded-lg shadow-lg p-6 md:p-8">
      ...
      <h2 className="text-2xl font-bold text-[#1b4332] mb-6 border-b pb-3">Official Event Vendor Application</h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <select
            ...
            className="w-full border border-gray-300 rounded-md p-3 text-gray-900 bg-amber-50 focus:ring-2 focus:ring-[#1b4332] font-medium"
        ...
        <div className="bg-emerald-50 border border-emerald-200 rounded-md p-4 space-y-1 text-sm text-emerald-900">

          <p><strong className="font-semibold">Event Name:</strong> {currentEvent.name}</p>

          <p><strong className="font-semibold">Date:</strong> {currentEvent.date}</p>

          <p><strong className="font-semibold">Time:</strong> {currentEvent.time}</p>

          <p><strong className="font-semibold">Vendor Application Fee:</strong> <span className="text-amber-700 font-bold">{currentEvent.fee}</span></p>
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-md p-4 text-xs text-gray-600 space-y-2">
          ...
          <div className="pt-2 flex items-center space-x-2">
            ...
            <input
              ...
              className="h-4 w-4 text-[#1b4332] rounded border-gray-300"
        ...
        <div>
          ...
          <input
            ...
            className="w-full border border-gray-300 rounded-md p-2.5 font-mono text-sm"
        ...
        <button
          ...
          className="w-full bg-[#1b4332] hover:bg-[#112d22] text-white font-bold py-3 px-6 rounded-md shadow-md transition-colors"

        >

          {isSubmitting ? 'Submitting Application...' : 'Submit Application & Proceed to Payment ($20.00)'}
