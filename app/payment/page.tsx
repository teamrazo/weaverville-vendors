  ...
  return (
    <div className="bg-white rounded-xl shadow-chamber border border-chamber-gold/30 p-6 md:p-8 text-center max-w-xl mx-auto space-y-6">
      ...
      <button
        ...
        className="w-full bg-chamber-accent hover:bg-chamber-accentDark text-white font-bold py-3 px-6 rounded-md shadow-chamber transition-colors uppercase tracking-wide text-sm"
      >
